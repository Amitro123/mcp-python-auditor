...
✅ **Defensive Data Handling**: Always validate tool output types (isinstance dict/list) before accessing keys in report generators to prevent crashes from error strings.
