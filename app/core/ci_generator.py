...
class CIGenerator:
    ...
    def generate_github_actions(self, auto_fix: bool = True) -> str:
        ...
        workflow_content = """# Python Auditor CI Pipeline
      ...
      - name: Comment on PR
        ...
        with:
          script: |
            ...
            ${{score < {self.score_threshold} ? '> **Action Required:** Fix issues above.' : '> All checks passed!'}}
...
"""
    ...
    def generate_bitbucket_pipelines(self, auto_fix: bool = True) -> str:
        ...
        """
        pipelines_content = """# Python Auditor CI Pipeline for Bitbucket
